...
class SnekEnv(gym.Env):
    ...
    def __init__(self, rending=False):
    ...
    def step(self, action):
        ...
        self.total_reward = ((250 - euclidean_dist_to_apple - self.iterAround ) + apple_reward) / 100
        ...
        # a parameter to see how much time it wastes going around the apple
        self.iterAround = 0
